...
export const GrassViewer = async (props: Props) => {
  ...
  return (
    <>
      <ScrollArea type="scroll" className="w-full whitespace-nowrap">
        <div className="flex w-max items-start gap-0.5">
                  ...
                  return (
                    <HoverCard key={day.date}>
                      <HoverCardTrigger asChild>
                        <span
                          className="aspect-square w-[12px] shrink-0 rounded-[2px] md:w-[10px]"
                          style={{
                            backgroundColor: getTwBgColor(day.contributionCount),
                          }}
                        />
                      </HoverCardTrigger>
                      <HoverCardContent className="w-full p-3">
