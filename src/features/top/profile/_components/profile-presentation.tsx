  ...
  return (
    <div className="w-full min-w-[250px] overflow-hidden rounded-md bg-white shadow-[0_0px_5px_0px_rgba(0,0,0,0.1)]">
      <div className="grid">
        ...
        <div className="relative col-start-1 row-start-1 aspect-square w-[30%] self-end justify-self-center overflow-hidden rounded-full bg-white shadow-[0_0px_5px_0px_rgba(0,0,0,0.3)]">
      ...
      <div className="flex flex-col gap-4 p-3 pt-1">
        <div className="flex flex-col items-center">
          <p className="text-lg text-gray-800">Yoshihito Saito</p>
          <p className="text-xs text-gray-500">Web & App dev</p>
        </div>
        <IconList />
        <hr />
        <div className="flex items-center justify-center">
          <p className="break-all text-sm text-gray-700">Waseda Univ.</p>
        </div>
      </div>
    </div>
  );
